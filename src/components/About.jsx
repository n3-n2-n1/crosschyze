...
const About = () => {
  return (
    <>
      ...
      >
    Blockchain Meets Simplicity CROSSCHYZE combines the power of blockchain technology with intuitive integration tools. 
    From credit cards to wallets and bank transfers, our platform makes it easy for businesses to centralize their payment solutions.
      </motion.p>
